      ...
      return new Promise((resolve, reject) => {
        this.http.post(Constants.API_URL + 'login/', JSON.stringify(this.usuarioEntity), this.options)
          ...
          .subscribe(data => {
            ...
            return this._storage.set(Constants.ID_USUARIO, data.idUsuario);
            return this._storage.set(Constants.TOKEN_USUARIO, data.token);
            return this._storage.set(Constants.NOME_PESSOA, data.nomePessoa);
            ...
            console.log(localStorage.getItem(Constants.TOKEN_USUARIO));
