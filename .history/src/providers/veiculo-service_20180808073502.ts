...
//   private veiculoEntity: VeiculoEntity;
  ...
  public findVeiculosCliente() {
      try {
        ...
        return new Promise((resolve, reject) => {
          // this._storage.get(Constants.TOKEN_USUARIO).then((tokenUsuario) => {
            this._http.post(Constants.API_URL + 'findVeiculosClienteq/'
            ...
            return new Promise((resolve, reject) => {
              // this._storage.get(Constants.TOKEN_USUARIO).then((tokenUsuario) => {
                this._http.post(Constants.API_URL + 'findListModeloVeiculo/'
                  + localStorage.getItem(Constants.TOKEN_USUARIO), 
                  JSON.stringify(this.modeloEntity), this.options)
                  .map(res=>res.json())
                  .subscribe(data => {
                    resolve(data);
                  }, (err) => {
          ...
          return new Promise((resolve, reject) => {
            // this._storage.get(Constants.TOKEN_USUARIO).then((tokenUsuario) => {
              this._http.post(Constants.API_URL + 'detalheVeiculosCliente/'
                + localStorage.getItem(Constants.TOKEN_USUARIO), 
                JSON.stringify(idVeiculo), this.options)
                .map(res=>res.json())
                .subscribe(data => {
                  resolve(data);
                }, (err) => {
  ...
  public findHistoricoVeiculoByVeiculo(historicoVeiculoEntity) {
    try {
        return new Promise((resolve, reject) => {
          this._http.post(Constants.API_URL + 'findHistoricoVeiculoByVeiculo/'
            + localStorage.getItem(Constants.TOKEN_USUARIO), 
            JSON.stringify(historicoVeiculoEntity), this.options)
            .map(res=>res.json())
            .subscribe(data => {
              resolve(data);
            }, (err) => {
  ...
  public findDetalhaHistoricoVeiculo(historicoVeiculoEntity) {
    try {
        return new Promise((resolve, reject) => {
          this._http.post(Constants.API_URL + 'findDetalhaHistoricoVeiculo/'
            + localStorage.getItem(Constants.TOKEN_USUARIO), 
            JSON.stringify(historicoVeiculoEntity), this.options)
            .map(res=>res.json())
            .subscribe(data => {
  ...
  public removerVeiculo(veiculoEntity) {
    try {
      return new Promise((resolve, reject) => {
        this._http.post(Constants.API_URL + 'removerVeiculo/'
          + localStorage.getItem(Constants.TOKEN_USUARIO), 
          JSON.stringify(veiculoEntity), this.options)
          .map(res=>res.json())
          .subscribe(data => {
