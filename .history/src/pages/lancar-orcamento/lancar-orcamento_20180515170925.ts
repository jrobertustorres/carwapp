...
export class LancarOrcamentoPage {
  ...
  selecionaDataSolicitacao() {
    ...
    .then(dataSolicitacao => {
      ...
      // this.orcamentoEntity.dataSolicitacao = dataSolicitacao.toISOString();
    }, (err) => {
  ...
  submeterOrcamento() {
    ...
    // if (this.lancarOrcamentoForm.valid) {
      try {
        ...
        // this.lancarOrcamentoForm.controls.dataSolicitacao.enable();
        console.log(this.lancarOrcamentoForm.value);
        console.log(this.dataSolicitacao);
        
        // this.orcamentoEntity.dataSolicitacao = this.dataSolicitacao;
        let dataSolic = new Date(this.dataSolicitacao);
        this.orcamentoEntity.dataSolicitacao = dataSolic;
