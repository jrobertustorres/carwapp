...
export class LancarOrcamentoPage {
  ...
  submeterOrcamentoConfirm() {
    let confirm = this.alertCtrl.create({
      title: 'Lançar orçamento',
      message: 'Tudo certo, podemos lançar este orçamento?',
      buttons: [
        {
          text: 'CANCELAR',
          handler: () => {
  ...
  submeterOrcamento() {
    ...
    // if (this.lancarOrcamentoForm.valid) {
      try {
        ...
        this.orcamentoEntity.listServicoOrcamento[0].descricao = this.lancarOrcamentoForm.value.descricao;
