...
export class ServicosListPage {
  ...
  showModalTipoFiltro(idServico){
    ...
    modal.onDidDismiss((data) => {
      if (data) {
        console.log(data.filter.idCidade.idCidade);
        // let idCidadeFiltro = data.filter.idCidade.idCidade ? data.filter.idCidade.idCidade : null;
        this.openOficinasList(idServico, data.filter.idCidade.idCidade, this.idVeiculo);
      }
    });
