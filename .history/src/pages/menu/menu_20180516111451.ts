...
export class MenuPage implements OnInit{
  ...
  pages: Array<{title: string, component: any, isVisible: boolean, icon: string, id: number}>;
  ...
  constroiMenu() {
    ...
    this.pages = [
      { title: 'Home', component: HomePage, isVisible: true, icon: 'ios-home', id: 1 },
      { title: 'Meus orçamentos', component: OrcamentosListPage, isVisible: true, icon: 'ios-albums', id: 2 },
      { title: 'Meus veículos', component: VeiculosListPage, isVisible: true, icon: 'ios-car', id: 3 },
      { title: 'Histórico de manutenção', component: VeiculosListPage, isVisible: true, icon: 'ios-archive', id: 4 },
      { title: 'Configurações', component: ConfiguracoesPage, isVisible: true, icon: 'ios-settings', id: 5 },
    ];
