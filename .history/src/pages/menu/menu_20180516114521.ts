...
export class MenuPage implements OnInit{
  ...
  pages: Array<{title: string, component: any, isVisible: boolean, icon: string, name: string}>;
  ...
  constroiMenu() {
    ...
    this.pages = [
      { title: 'Home', component: HomePage, isVisible: true, icon: 'ios-home', name: 'home' },
      { title: 'Meus orçamentos', component: OrcamentosListPage, isVisible: true, icon: 'ios-albums', name: 'orcamento' },
      { title: 'Meus veículos', component: VeiculosListPage, isVisible: true, icon: 'ios-car', name: 'veiculo' },
      { title: 'Histórico de manutenção', component: VeiculosListPage, isVisible: true, icon: 'ios-archive', name: 'historico' },
      { title: 'Configurações', component: ConfiguracoesPage, isVisible: true, icon: 'ios-settings', name: 'config' },
    ];
