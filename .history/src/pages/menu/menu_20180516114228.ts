...
export class MenuPage implements OnInit{
  ...
  pages: Array<{title: string, component: any, isVisible: boolean, icon: string, identificador: string}>;
  ...
  constroiMenu() {
    ...
    this.pages = [
      { title: 'Home', component: HomePage, isVisible: true, icon: 'ios-home', identificador: 'home' },
      { title: 'Meus orçamentos', component: OrcamentosListPage, isVisible: true, icon: 'ios-albums', identificador: 'orcamento' },
      { title: 'Meus veículos', component: VeiculosListPage, isVisible: true, icon: 'ios-car', identificador: 'veiculo' },
      { title: 'Histórico de manutenção', component: VeiculosListPage, isVisible: true, icon: 'ios-archive', identificador: 'historico' },
      { title: 'Configurações', component: ConfiguracoesPage, isVisible: true, icon: 'ios-settings', identificador: 'config' },
    ];
