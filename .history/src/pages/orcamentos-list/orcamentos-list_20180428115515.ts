...
export class OrcamentosListPage {
  ...
  verificaStatusOrcamento(idOrcamento, statusOrcamento) {
    if (statusOrcamento == 'ABERTO') {
      // this.detalheOrcamento(idOrcamento);
      ...
      // this.orcamentosRespondidosList(idOrcamento);
    }
  }
  ...
  // orcamentosRespondidosList(idOrcamento) {
  //   this.navCtrl.push(OrcamentosRespondidosListPage, {
