...
export class OficinasListPage {
  ...
  fornecedoresChecked(fornecedores) {
    this.fornecedoresSelecionados.push(fornecedores);
    console.log(fornecedores);
    // if (this.fornecedoresSelecionados !== -1) {
      // this.fornecedoresSelecionados.splice(this.fornecedoresSelecionados, fornecedores);
  // } 
  this.fornecedoresSelecionados.remove(fornecedores);
