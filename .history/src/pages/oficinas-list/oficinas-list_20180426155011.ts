...
export class OficinasListPage {
  ...
  fornecedoresChecked(fornecedor) {
    // this.fornecedoresSelecionados['idFornecedor'] = fornecedor;

    if (this.fornecedoresSelecionados.indexOf(fornecedor) == -1) {
      this.fornecedoresSelecionados['idFornecedor'].push(fornecedor);
      this.contador = this.contador +1;
    }else{
      this.fornecedoresSelecionados['idFornecedor'].splice(this.fornecedoresSelecionados.indexOf(fornecedor),1);
