...
export class OficinasListPage {
  ...
  public fornecedoresSelecionados: ServicoOrcamentoEntity[] = [];
  ...
  lancarOrcamento(descricao) {
    ...
    // this.orcamentoEntity.listServicoOrcamento = this.listServicoOrcamento;
    // this.orcamentoEntity.listServicoOrcamento = this.fornecedoresSelecionados;
