...
export class OficinasListPage {
  ...
  verificaRegistrosSelecionados() {
    console.log(localStorage.getItem(Constants.POSSUI_VEICULO));
    if (localStorage.getItem(Constants.POSSUI_VEICULO) != false) {
  ...
  showVeiculoAlert() {
    let prompt = this.alertCtrl.create({
      ...
      message: "Para lançar orçamentos é necessário ter um veículo cadastrado!",
      buttons: [
        {
          text: 'OK',
          handler: data => {
