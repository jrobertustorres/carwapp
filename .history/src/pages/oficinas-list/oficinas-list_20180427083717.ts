...
export class OficinasListPage {
  ...
  private fornecedoresSelecionados: Array<Object> = [];
  private listIdVeiculo: Array<Object> = [];
  ...
  // this.fornecedoresSelecionados['idFornecedor'] = this.fornecedoresSelecionados;
    ...
    this.orcamentoEntity['istIdVeiculo'] = this.listIdVeiculo;
    this.orcamentoEntity['fornecedoresSelecionados'] = this.fornecedoresSelecionados;
