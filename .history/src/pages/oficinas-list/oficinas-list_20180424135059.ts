...
export class OficinasListPage {
  ...
  findOficinasList() {
    ...
    localStorage.setItem('latitudeFornecedores', this.fornecedores.latitude);
    localStorage.setItem('longitudeFornecedores', this.fornecedores.longitude);

    console.log(localStorage.getItem('latitudeFornecedores'));
    console.log(localStorage.getItem('longitudeFornecedores'));

    console.log(this.fornecedores);
    console.log(this.fornecedores.latitude);
