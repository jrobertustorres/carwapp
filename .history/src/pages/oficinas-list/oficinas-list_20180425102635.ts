...
export class OficinasListPage {
  ...
  buscaOficinas() {
    ...
    // localStorage.removeItem('fornecedoresMapa');
    localStorage.setItem('fornecedorLatitude', JSON.stringify(this.fornecedorEntity.latitude));
    localStorage.setItem('fornecedorLongitude', JSON.stringify(this.fornecedorEntity.longitude));

    localStorage.setItem('fornecedoresMapa', JSON.parse(this.fornecedores));
  ...
  applyHaversine(locations){
    ...
    let usersLocation = {
      // lat: this.fornecedorEntity.latitude,
      // lng: this.fornecedorEntity.longitude
        lat: -18.912697,
        lng: -48.311463
        // lat: 40.713744,
        // lng: -74.009056
