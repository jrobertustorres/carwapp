...
export class OficinasListPage {
  ...
  swipeSlide(itemSlide: ItemSliding) {
    console.log('here');
    console.log(this.activeItemSliding);
    this.closeOption();
  }

  clickSlide(itemSlide: ItemSliding, item: Item) {

    // if(this.activeItemSliding!==null || itemSlide.getSlidingPercent() == 0){
    if(this.activeItemSliding!==null){
      this.closeOption();
    }

    console.log(itemSlide.getSlidingPercent());
    console.log(this.activeItemSliding);

    // itemSlide.getSlidingPercent() == 0
