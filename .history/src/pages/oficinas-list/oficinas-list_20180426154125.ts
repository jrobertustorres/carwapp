...
export class OficinasListPage {
  ...
  listServicoOrcamento['idServico'] = this.idServico;
  listServicoOrcamento['descricao'] = descricao;
  console.log(listServicoOrcamento);

    // this.listServicoOrcamento.push(this.idServico);
    // this.listServicoOrcamento.push(descricao);
    this.orcamentoEntity.listServicoOrcamento = listServicoOrcamento; // idservico e descricao
