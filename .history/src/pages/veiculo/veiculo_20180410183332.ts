...
export class VeiculoPage {
  ...
  ngOnInit() {
    ...
    this.veiculoForm = this.formBuilder.group({
      ...
      'renavan': ['', Validators.maxLength(100)],
  ...
  findMarcaVeiculo() {
    ...
    this.loading.dismiss();
    this.findListModeloVeiculo(this.marcasVeiculo.idMarca);
  ...
  getDetalheVeiculo() {
    try {
      ...
      this.veiculoService.getDetalheVeiculo(this.veiculoEntity)
      .then((veiculoEntityResult: veiculoEntity) => {
        this.veiculoEntityEntity = veiculoEntityResult;

        console.log(this.veiculoEntityEntity);
        this.loading.dismiss();
