...
export class MeusDadosPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dadosUsuarioForm = this.formBuilder.group({
      ...
      'cpfPessoa': ['', [Validators.required, Validators.maxLength(20)]],
  ...
  editaUsuario() {
    ...
    .then((usuarioDetalheEntityResult: UsuarioDetalheEntity) => {
      ...
      this.userChangeEvent.emit(usuarioDetalheEntityResult.nomePessoa);
      this.emailPessoaChangeEvent.emit(usuarioDetalheEntityResult.emailUsuario);
      this.loading.dismiss();
      this.presentToast();
      setTimeout(() => {
