...
export class MeusDadosPage implements OnInit {
  ...
  getValorTelefone(telefone) {
    ...
    console.log(telefone.replace(/\D/g, '').replace(/(\d{2})(\d)(\d{4})(\d{4})$/, '($1) $2 $3-$4'));
  }
    ...
    try {
      ...
      this.usuarioService
        ...
        .then((dadosUsuarioDetalheResult) => {
          ...
          console.log(this.usuarioDetalheEntity.telefonePessoa);
          console.log(this.usuarioDetalheEntity.telefonePessoa.replace(/\D/g, '').replace(/(\d{2})(\d)(\d{4})(\d{4})$/, '($1) $2 $3-$4'));
